                    ...
                    <td>
                        <div class="d-flex gap-2 justify-content-end align-items-center">
                            ...
                            <form action="{{ route('jenis.destroy', $item) }}" method="POST" class="d-inline m-0 p-0"
                                data-confirm="Apakah Anda yakin akan menghapus jenis &quot;{{ $item->nama }}&quot;?"
                                data-confirm-danger="true"
                                data-confirm-ok-text="Ya, Hapus">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-action-delete py-1 px-2 lh-sm" style="font-size: 13px !important;">
                                    Hapus
                                </button>
                            </form>
                        </div>
