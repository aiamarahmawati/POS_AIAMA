...
<div class="container mt-4">
    ...
    <div class="table-filter-action d-flex justify-content-between align-items-center mb-3">
        <form action="{{ route('paket.index') }}" method="GET" class="search-wrapper d-flex">
            ...
            <tbody>
                @forelse ($pakets as $paket)
                    <tr>
                        ...
                        <td>
                            {{-- Breakdown isi paket, sesuai pilihan: nama paket + breakdown produknya --}}
                            ...
                            <div class="d-flex gap-2 justify-content-end align-items-center">
                                ...
                                @can('delete', $paket)
                                    <form action="{{ route('paket.destroy', $paket) }}" method="POST"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-outline-danger py-1 px-2 lh-sm"
